...
\firstname{Parth} % Your first name
...
\address{B-40, Shivalaya-2, South Bopal}{Ahmedabad, Gujarat 380058}
\mobile{+91 815 590 3610}
% \phone{(000) 111 1112}
% \fax{(000) 111 1113}
\email{XinYaanZyoy@astrospacetech.in}
...
\quote{
    % ब्रह्मात्सर्वमुदच्यते। 
    {\skt bra;hmaa;tsavRa;mau;d;cyatae \ZS{12}@A}
    \\The Whole Existence Emerges out of an infinite primordial ocean called Brahman.
    \begin{CJK*}{UTF8}{gbsn}
        \\- XinYaanZyoy (心言自由) The Helper Boy
    \end{CJK*}
}
...
\cventry{2017--2021}{Bachelor of Technology}{GNA University}{Punjab}{\textit{GPA -- 6.0}}{Specialized in Aerospace Engineering}
...
\cvitemwithcomment{Gujarati}{Mothertongue}{Philosophically verbose}
\cvitemwithcomment{Hindi}{Intermediate}{Conversationally fluent}
\cvitemwithcomment{English}{Professional}{Conversationally fluent}
