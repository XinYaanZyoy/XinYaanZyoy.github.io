...
i spend my most of the time studying mathematics(Linear Algebra and Partial Differential Calculus to be specific) of transformations of vector fields, i study continuum mechanics and try to implement it on my computer using various algorithms used in CFD, i study AI(NNs to be specific) and try to merge those Data Algorithms to CFD solutions, i study Quantum mechanics(probability waves to be specif); i try to understand and make my own interpretation of those weird quantum waves, i study Astrophysics(gravitational waves to be specific); i'm still in learning stage here, i'm interested in Astrobiology, computational chemistry and quantum computing; which three i guess co-relates, but these days i'm working on computational mathematics; the logic which would logic itself (turing machines to be specific) in this again i'm "new born", soon after i finish my this degree i want to do Phd. in computational Engineering and Sciences at UT Austin.
...
- public presentation (i've given few lectures on QM, PPTs on mathematics, and space exploration)
...
i'm still under progress to know what i actually am, but here's a thing...

> i for certain don't know anything; except, i "know" that i don't know!

but here's what i think i ain't,
> #### i ain't ...
- Parth Patel, that's a name recognized by my early life surrounding people.
- XinYaanZyoy, that's a name recognized by people on the internet.
...
- ain't clay box, of which skin you'd touch,
- ain't esterified soil, of which scent you'd smell,
- ain't glowing lips, of which tang you'd taste,
- ain't energy, of which presence you'd feel,
